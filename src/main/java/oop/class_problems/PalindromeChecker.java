...
public class PalindromeChecker{
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Iterative: "+ (iterative ? "Palindrome" : "Not Palindrome")+" | "+"Recursive: "+ (recursive ? "Palindrome" : "Not Palindrome")+" | "+"Array Reversal: "+ (arrayReversal ? "Palindrome" : "Not Palindrome"));        
        sc.close();
    }
}